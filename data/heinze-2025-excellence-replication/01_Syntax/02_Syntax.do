...
* Robustness Check with OLS regression
reg Exz_gefoerdert_FJ Profs 
	est store model1
reg Exz_gefoerdert_FJ Profs Drittmitteleinnahmen 
	est store model2
reg Exz_gefoerdert_FJ Profs Drittmitteleinnahmen DM_DFG_Mittel 
	est store model3
reg Exz_gefoerdert_FJ Profs Drittmitteleinnahmen DM_DFG_Mittel StudierendeGesamt
	est store model4
...
esttab model1 model2 model3 model4 using ///
	"$tables/Appendix11.rtf" ///
	 , append not b(%9.6f) ///
	   star nodepv nonum nogaps compress ///
	   label varwidth(15) ///
	   title("Table 11c: Robustness check. Linear regression, first “initiative” phase (2006–2011), all universities, incl. citations.") ///
		scalars(r2) varlabel(_cons Intercept) unstack nobaselevels

		
* Robustness Check with log. Values
foreach var of varlist Exz_gefoerdert_FJ Profs Drittmitteleinnahmen DM_DFG_Mittel StudierendeGesamt  {
gen `var'_plus1 = `var'+1
gen log`var'= log(`var'_plus1)
}

logit logExz_gefoerdert_FJ logProfs 
	est store model1
logit logExz_gefoerdert_FJ logProfs logDrittmitteleinnahmen 
	est store model2
logit logExz_gefoerdert_FJ logProfs logDrittmitteleinnahmen logDM_DFG_Mittel 
	est store model3
logit logExz_gefoerdert_FJ logProfs logDrittmitteleinnahmen logDM_DFG_Mittel logStudierendeGesamt
	est store model4
...
esttab model1 model2 model3 model4 using ///
	"$tables/Appendix11.rtf" ///
	 , append not b(%9.6f) ///
	   star nodepv nonum nogaps compress ///
	   label varwidth(15) ///
	   title("Table 11e: Robustness check. Logistic regression (logged variables), first “initiative” phase (2006–2011), all universities, incl. citations.") ///
		scalars(r2_p) varlabel(_cons Intercept) unstack nobaselevels
...
reg Exz_gefoerdert_FJ Profs Drittmitteleinnahmen DM_DFG_Mittel StudierendeGesamt 
	est store model4
reg Exz_gefoerdert_FJ Profs Drittmitteleinnahmen DM_DFG_Mittel StudierendeGesamt i.FoerderungPhase1 
	est store model5
...
esttab model1 model2 model3 model4 model5 using ///
	"$tables/Appendix11.rtf" ///
	 , append not b(%9.6f) ///
	   star nodepv nonum nogaps compress ///
	   label varwidth(15) ///
	   title("Table 11d: Robustness check. Linear regression, second “initiative” phase (2012–2017), all universities.") ///
		scalars(r2) varlabel(_cons Intercept) unstack nobaselevels
...
logit logExz_gefoerdert_FJ logProfs logDrittmitteleinnahmen logDM_DFG_Mittel logStudierendeGesamt
est store model4
logit logExz_gefoerdert_FJ logProfs logDrittmitteleinnahmen logDM_DFG_Mittel logStudierendeGesamt i.FoerderungPhase1 
	est store model5
...
"$tables/Appendix11.rtf" ///
 , append not b(%9.6f) ///
   star nodepv nonum nogaps compress ///
   label varwidth(15) ///
   title("Table 11f: Robustness check. Logistic regression (logged variables), second “initiative” phase (2012–2017), all universities.") ///
	scalars(r2_p) varlabel(_cons Intercept) unstack nobaselevels

* Grants = 5 Quartile:
xtile Drittmittel_quartile=Drittmitteleinnahmen,n(5)

logit Exz_gefoerdert_FJ Profs
est store model1
logit Exz_gefoerdert_FJ Profs i.Drittmittel_quartile
est store model2
logit Exz_gefoerdert_FJ Profs i.Drittmittel_quartile DM_DFG_Mittel
est store model3
logit Exz_gefoerdert_FJ Profs i.Drittmittel_quartile DM_DFG_Mittel StudierendeGesamt
est store model4
logit Exz_gefoerdert_FJ Profs i.Drittmittel_quartile DM_DFG_Mittel StudierendeGesamt i.FoerderungPhase1
est store model5
...
"$tables/Appendix11.rtf" ///
 , append not b(%9.6f) ///
   star nodepv nonum nogaps compress ///
   nomtitle label varwidth(15) ///
   title ("Table 11g: Logistic regression, second “initiative” phase (2012–2017), all universities") ///
   scalars(r2_p) varlabel(_cons Intercept) unstack nobaselevels
